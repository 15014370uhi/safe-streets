 ...
 * 
 * @return {object} All crime records for time period, location and filters, or 12 months records
 */ 
const populateCrimesArray = async (
  ...
  for (let crimeCollection of recordedCrimes) {
    for (let aCrime of crimeCollection) {
      ...
      let aCrimeMonth = aCrimeDate.getMonth () + 1;
  ...
  console.log('CRIME ==console.log(typeof crimesToDisplay)======= RESULTS: ' + typeof crimeResults);
...
router.post ('/', async (req, res) => {
  ...
  console.log(typeof crimesToDisplay);
